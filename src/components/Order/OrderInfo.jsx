...
import { setShippingAdress } from "../../features/cart/cartSlice";
import { useDispatch } from "react-redux";
import { useNavigate } from "react-router-dom";

const OrderInfo = () => {
  const navigate = useNavigate();
  const getSessionLogin = useSelector((state) => state.auth);
  ...
  const handleOrderSubmit = (e) => {
    e.preventDefault();
    dispatch(setShippingAdress(OrderInfoForm));
  ...
  return (
    <section className="bg-white py-8 antialiased">
      ...
      >
        <ol className="sticky top-36 items-center flex w-full text-center text-sm font-medium text-gray-500 dark:text-gray-400 sm:text-base">
        ...
        <div className="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12 xl:gap-16">
          ...
          <div className="sticky top-52 mt-6 w-full space-y-6 sm:mt-8 lg:mt-0 lg:max-w-xs xl:max-w-md">
            ...
            <div className="space-y-3">
              <button className="flex w-full items-center justify-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium bg-emerald-400 text-white hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                Proceed to Payment
              </button>
